...
public class PreLoadRn {
    ...
    public static void proload(Activity activity) {
        ...
        while (iter.hasNext()) {
            ...
            PreLoadRn.preLoad(activity, key, MainApplication.prams);
        }
    }
    ...
    public static void clear() {
        ...
        // 清除预加载缓存类中的数据
        PreLoadRn.ReactRootViewCache.clear();
    }
    ...
    public static void preLoad(Activity activity, String componentName, String prams) {
        ...
        if (ReactRootViewCache.get(componentName) != null) {
            //如果缓存中有该页面先移除页面中的RN页
            PreLoadRn.deatchView(componentName);
            return;
        }
        ...
        rootView.startReactApplication(
                ...
                componentName,
                PreLoadRn.getLaunchOptions(prams));
        // 2.添加到缓存
    ...
    public static void deatchView(String component) {
        try {
            ReactRootView rootView = PreLoadRn.getReactRootView(component);
            if (rootView != null) {

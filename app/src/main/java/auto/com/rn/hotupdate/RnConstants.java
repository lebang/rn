...
public class RnConstants {
     ...
     * zip文件名
     */
    public static final String ZIP_NAME = "rn_zip";
     ...
     * sdcard中应用对应的文件夹和目录
     */
    public static final String JS_PATCH_BASIC = Environment.getExternalStorageDirectory().toString() + File.separator +
